class Calculator{
    ...
    chooseOperation(operation){
        ...
        //do the mathematicallogic operation
    compute(){
        let computation
        const prev = parseFloat(this.previousOperand) // converts this.previousOperand back to number
        const current = parseFloat(this.currentOperand)
        // until the person fills in a current operand/number compute function should not run
...
// to enable us choose a new operation
